...
class questiontype_test extends advanced_testcase {
    ...
    public function test_reorder_answers0() {
        ...
        $this->assertEquals([0 => 1, 1 => 0], $this->qtype->reorder_answers($questiontext, $answers));
    }

    /**
     * Test reorder answers1
     */
    public function test_reorder_answers1() {
        ...
        $answers = [0 => $ans1, 1 => $ans2, 2 => $ans3, 3 => $ans4];
        $this->assertEquals([0 => 2, 1 => 3, 2 => 0, 3 => 1], $this->qtype->reorder_answers($questiontext, $answers));
    }

    /**
     * Test reorder answers2
     */
    public function test_reorder_answers2() {
        ...
        $ans4->placeholder = '';
        $answers = [0 => $ans1, 1 => $ans2, 2 => $ans3, 3 => $ans4];
        $this->assertEquals([0 => 0, 1 => 1, 2 => 2, 3 => 3], $this->qtype->reorder_answers($questiontext, $answers));
    }

    /**
     * Test check placeholder
     */
    public function test_check_placeholder() {
    ...
    public function test_get_question_options() {
        ...
        $this->assertStringContainsString(
            'Failed to load question options from the table qtype_formulas_options for questionid ' . $question->id, $html);
        $this->assertInstanceOf(stdClass::class, $question->options);
        $options = $question->options;
        $this->assertEquals($question->id, $options->questionid);
        $this->assertEquals(1, $options->numpart);
