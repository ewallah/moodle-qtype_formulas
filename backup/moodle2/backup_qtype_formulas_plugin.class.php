...
class backup_qtype_formulas_plugin extends backup_qtype_plugin {
    ...
    protected function define_question_plugin_structure() {
        ...
        $formulas = new backup_nested_element('formulas', ['id'], [
            'varsrandom', 'varsglobal', 'correctfeedback', 'correctfeedbackformat', 'partiallycorrectfeedback',
            'partiallycorrectfeedbackformat', 'incorrectfeedback', 'incorrectfeedbackformat', 'shownumcorrect',
            'answernumbering']);
